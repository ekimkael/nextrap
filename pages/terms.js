		...
		<>
			...
			<div class="col-md-8 mx-auto">
				<h1>
					...
					<span class="highlight preview_company_name"> Nextrap</span>
				</h1>
				<h2>Introduction</h2>
				<p>
					These Website Standard Terms and Conditions written on this webpage
					shall manage your use of our website,{" "}
					<span class="highlight preview_website_name">Webiste Name</span>{" "}
					accessible at{" "}
				...
				<p>
					...
					and <span class="highlight preview_company_name">Company Name</span>{" "}
					...
					have for this Website are confidential and you must maintain
				...
				<p>
					...
					<span class="highlight preview_company_name">Company Name</span> a
				...
				<p>
					In no event shall{" "}
					<span class="highlight preview_company_name">Company Name</span>, nor
					any of its officers, directors and employees, shall be held liable for
				...
				<p>
					<span class="highlight preview_company_name">Company Name</span> is
				...
				<h2>Assignment</h2>
				<p>
					The <span class="highlight preview_company_name">Company Name</span>{" "}
				...
				<p>
					...
					<span class="highlight preview_company_name">Company Name</span> and
				...
				<p>
					...
					<span class="highlight preview_country">Country</span>, and you submit
					to the non-exclusive jurisdiction of the state and federal courts
					located in <span class="highlight preview_country">Country</span> for
